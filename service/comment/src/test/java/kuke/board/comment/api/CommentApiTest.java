...
//          commentId=123694722045702144
    ...
    void read() {
        CommentResponse response = restClient.get()
                .uri("/v1/comments/{commentId}", 142857779725647872L)
                .retrieve()
                .body(CommentResponse.class);
    ...
    void readAll() {
        ...
        /**
         * 1번 페이지 수행 결과
         * comment.getCommentId() = 142857779725647872
         * 	comment.getCommentId() = 142857780547731456
         * 	comment.getCommentId() = 142857780656783360
         * comment.getCommentId() = 142858317026091008
         * 	comment.getCommentId() = 142858317105782784
         * comment.getCommentId() = 142858317026091009
         * 	comment.getCommentId() = 142858317105782789
         * comment.getCommentId() = 142858317026091010
         * 	comment.getCommentId() = 142858317105782790
         * comment.getCommentId() = 142858317030285312
         */
    }
